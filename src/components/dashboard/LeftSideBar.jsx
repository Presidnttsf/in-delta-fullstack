...
export default function LeftSideBar() {
    ...
    // console.log("usercontextperson", person.profilePicture)
            ...
            <div className="sidebar-content">
                <div className="sidebar-admin pt-5 pb-md-4">
                    <div className="admin-profile text-center pt-3">
                        ...
                        <img src={person.profilePicture || "images/sidebar-admin-profile.png"} alt="Admin" className="admin-border-img" />
